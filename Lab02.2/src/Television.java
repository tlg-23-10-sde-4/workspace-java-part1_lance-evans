...
class Television {
    ...
    public void turnOn() {
        ...
        if (isConnected){
            ...
            isOn = false;
            System.out.println(getBrand() + " Television is not connected. Please check your connection.");
        }
    }
    ...
    public String toString(){
        ...
        return String.format("Television: %s; Volume: %s; DisplayType: %s.", getBrand(),
                volumeString, getDisplay());
        //return "Television: " + getBrand() + "; Volume: " + volumeString +
